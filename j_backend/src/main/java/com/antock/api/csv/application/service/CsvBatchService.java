...
public class CsvBatchService {
    ...
    private static final Map<City, List<District>> CITY_DISTRICT_MAP = Map.ofEntries(
            Map.entry(City.서울특별시, List.of(District.강남구, District.강동구, District.강북구, District.강서구)),
            Map.entry(City.부산광역시, List.of(District.부산강서구, District.부산금정구, District.부산남구, District.부산동구)),
            Map.entry(City.대구광역시, List.of(District.대구남구, District.대구달서구, District.대구동구, District.대구북구)),
            Map.entry(City.인천광역시, List.of(District.인천계양구, District.인천남구, District.인천동구, District.인천미추홀구)),
            Map.entry(City.광주광역시, List.of(District.광주광산구, District.광주남구, District.광주동구, District.광주북구)),
            Map.entry(City.대전광역시, List.of(District.대전대덕구, District.대전동구, District.대전서구, District.대전유성구)),
            Map.entry(City.울산광역시, List.of(District.울산남구, District.울산동구, District.울산북구, District.울산울주군)),
            Map.entry(City.세종특별자치시, List.of(District.세종특별자치시)),
            Map.entry(City.경기도, List.of(District.경기가평군, District.경기고양시, District.경기과천시, District.경기광명시)),
            Map.entry(City.강원특별자치도, List.of(District.강원강릉시, District.강원고성군, District.강원동해시, District.강원삼척시)),
            Map.entry(City.충청북도, List.of(District.충북괴산군, District.충북단양군, District.충북보은군, District.충북영동군)),
            Map.entry(City.충청남도, List.of(District.충남계룡시, District.충남공주시, District.충남금산군, District.충남논산시)),
            Map.entry(City.전라북도, List.of(District.전북고창군, District.전북군산시, District.전북김제시, District.전북남원시)),
            Map.entry(City.전라남도, List.of(District.전남강진군, District.전남고흥군, District.전남곡성군, District.전남광양시)),
            Map.entry(City.경상북도, List.of(District.경북경산시, District.경북경주시, District.경북고령군, District.경북구미시)),
            Map.entry(City.경상남도, List.of(District.경남거제시, District.경남거창군, District.경남고성군, District.경남김해시)),
    ...
    public void runBatch() {
        ...
        try {
            List<CompletableFuture<Void>> futures = CITY_DISTRICT_MAP.entrySet().stream()
                    .limit(maxConcurrent)
                    .map(entry -> CompletableFuture.runAsync(() -> processCityDistricts(entry.getKey(),
                            entry.getValue(), totalProcessed, totalSuccess, totalFailed)))
                    .toList();
