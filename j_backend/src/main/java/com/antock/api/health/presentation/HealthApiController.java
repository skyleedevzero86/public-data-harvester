...
public class HealthApiController {
    ...
    public ResponseEntity<ApiResponse<SystemHealthResponse>> getSystemHealth(
        ...
        try {
            ...
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                    .body(ApiResponse.error("시스템 헬스 상태 조회 중 오류가 발생했습니다."));
        }
    }
    ...
    public ResponseEntity<ApiResponse<SystemHealthResponse>> performHealthCheck(
        ...
        try {
            ...
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                    .body(ApiResponse.error("헬스 체크 실행 중 오류가 발생했습니다."));
        }
    }
    ...
    public ResponseEntity<ApiResponse<Page<HealthCheckResponse>>> getComponentHealth(
        ...
        try {
            ...
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                    .body(ApiResponse.error("컴포넌트 헬스 상태 조회 중 오류가 발생했습니다."));
        }
    }
    ...
    @PreAuthorize("hasRole('ADMIN')")
    public ResponseEntity<ApiResponse<Page<HealthCheckResponse>>> getHealthHistory(
        ...
        try {
            ...
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                    .body(ApiResponse.error("헬스 체크 이력 조회 중 오류가 발생했습니다."));
        }
    }
    ...
    public ResponseEntity<ApiResponse<Map<String, Object>>> cleanupExpiredData() {
        try {
            ...
            return ResponseEntity.ok(ApiResponse.of(HttpStatus.OK, result));
        } catch (Exception e) {
            log.error("헬스 체크 데이터 정리 실패", e);
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                    .body(ApiResponse.error("데이터 정리 중 오류가 발생했습니다."));
        }
    }
    ...
    @PreAuthorize("hasRole('ADMIN')")
    public ResponseEntity<ApiResponse<HealthMetricsResponse>> getHealthMetrics(
        ...
        try {
            ...
            return ResponseEntity.ok(ApiResponse.of(HttpStatus.OK, metrics));
        } catch (Exception e) {
            log.error("헬스 체크 메트릭 조회 실패", e);
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                    .body(ApiResponse.error("메트릭 조회 중 오류가 발생했습니다."));
        }
    }
    ...
    @PreAuthorize("hasRole('ADMIN')")
    public ResponseEntity<ApiResponse<HealthMetricsResponse.ComponentMetrics>> getComponentMetrics(
        ...
        try {
            ...
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                    .body(ApiResponse.error("컴포넌트 메트릭 조회 중 오류가 발생했습니다."));
        }
    }
    ...
    @PreAuthorize("hasRole('ADMIN')")
    public ResponseEntity<ApiResponse<HealthMetricsResponse>> getRealtimeMetrics() {
        try {
            ...
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                    .body(ApiResponse.error("실시간 메트릭 조회 중 오류가 발생했습니다."));
        }
    }
}