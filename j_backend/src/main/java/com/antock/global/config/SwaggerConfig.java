...
public class SwaggerConfig {
        ...
        private Parameter createPageParameter() {
                return new Parameter()
                        ...
                        .required(false)
                        .schema(new Schema<Integer>().type("integer").minimum(BigDecimal.ZERO)._default(0));
        }
        ...
        private Parameter createSizeParameter() {
                return new Parameter()
                        ...
                        .required(false)
                        .schema(new Schema<Integer>().type("integer").minimum(BigDecimal.ONE).maximum(BigDecimal.valueOf(100))._default(20));
        }
