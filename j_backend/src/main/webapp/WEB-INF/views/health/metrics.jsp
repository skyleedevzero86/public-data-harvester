...
<head>
  ...
  <title>헬스 체크 상세 메트릭 - Antock</title>
  ...
  <div class="row">
    <nav class="col-md-3 col-lg-2 d-md-block bg-light sidebar">
      <div class="position-sticky pt-3">
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="/health/metrics">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">
          <i class="fas fa-chart-line text-primary"></i> 헬스 체크 상세 메트릭
        </h1>
      ...
      <c:if test="${not empty metrics}">
          ...
          <div class="col-md-3">
            <div class="card metric-card">
              <div class="card-body text-center">
                ...
                <h5 class="card-title">평균 가동시간</h5>
          ...
          <div class="col-md-3">
            <div class="card metric-card">
              <div class="card-body text-center">
                ...
                <h5 class="card-title">평균 복구시간</h5>
                <div class="metric-value text-warning">
          ...
          <div class="col-md-8">
            <div class="card">
              <div class="card-header">
                <h5 class="card-title mb-0">시간대별 가용성 트렌드</h5>
              </div>
              <div class="card-body">
        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h5 class="card-title mb-0">컴포넌트별 상세 메트릭</h5>
              </div>
              <div class="card-body">
                <div class="table-responsive">
                  <table class="table table-hover">
                    ...
                    <c:forEach var="component" items="${metrics.componentMetrics}">
                      <tr>
                        <td>
                          <i class="fas fa-${component.component == 'database' ? 'database' : component.component == 'redis' ? 'memory' : component.component == 'cache' ? 'layer-group' : component.component == 'member-service' ? 'users' : 'tachometer-alt'}"></i>
                            ${component.component}
                        </td>
                        <td>
