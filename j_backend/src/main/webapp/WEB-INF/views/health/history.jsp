    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <h1><i class="fas fa-history"></i> 헬스 체크 이력</h1>
                <div>
    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="card filter-card">
                <div class="card-body">
                    <h5 class="card-title"><i class="fas fa-filter"></i> 필터</h5>
                    <form method="get" action="/health/history">
                        <div class="row">
                            <div class="col-md-4">
                                <label for="fromDate" class="form-label">시작 날짜</label>
                                <input type="datetime-local" class="form-control" id="fromDate" name="fromDate">
                            </div>
                            <div class="col-md-4">
                                <label for="toDate" class="form-label">종료 날짜</label>
                        ...
                        <div class="row mt-3">
                            <div class="col-12">
                                ...
                                <a href="/health/history" class="btn btn-outline-light">
        ...
        <div class="col-12">
            <div class="card health-card">
                <div class="card-header">
                    <h5 class="mb-0"><i class="fas fa-list"></i> 체크 이력</h5>
                </div>
                <div class="card-body">
                        ...
                        <table class="table table-hover">
                            ...
                            <c:forEach var="check" items="${healthChecks.content}">
                                <tr class="${check.healthy ? 'table-success' : 'table-danger'}">
                                    <td>
                                        <i class="fas fa-cog"></i> ${check.component}
                                    </td>
                                    <td>
                        ...
                        <nav aria-label="페이지 네비게이션">
                            <ul class="pagination justify-content-center">
                                <li class="page-item ${currentPage == 0 ? 'disabled' : ''}">
                                    <a class="page-link" href="?page=${currentPage - 1}&size=${param.size}&fromDate=${param.fromDate}&toDate=${param.toDate}">이전</a>
                                </li>
                                ...
                                <li class="page-item ${currentPage == totalPages - 1 ? 'disabled' : ''}">
                                    <a class="page-link" href="?page=${currentPage + 1}&size=${param.size}&fromDate=${param.fromDate}&toDate=${param.toDate}">다음</a>
                                </li>
                            </ul>
                        </nav>
                    </c:if>
