...
<head>
  ...
  <style>
    ...
    .password-find-links a:hover {
      color: #007bff;
      text-decoration: underline;
    }

    .password-find-links .divider {
      color: #dee2e6;
      margin: 0 10px;
    }
  </style>
          ...
          <div class="card-body">
            ...
            <form method="post" action="/members/login">
              <div class="mb-3">
                ...
                >사용자명 <span class="text-danger">*</span></label
                >
                <input
                        type="text"
                        class="form-control"
              ...
              <div class="text-center">
                <a href="/members/join" class="text-decoration-none">
                  <i class="bi bi-person-plus"></i> 계정이 없으신가요?
                  회원가입
                </a>
              </div>

              <div class="password-find-links">
                <a
                        href="/members/password/find"
                        class="text-decoration-none"
                >
                  <i class="bi bi-key"></i> 비밀번호를 잊으셨나요?
                </a>
              </div>
            </form>
          </div>
