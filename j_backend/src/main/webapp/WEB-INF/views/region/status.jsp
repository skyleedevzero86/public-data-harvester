...
<script>
  function initRegionCharts() {
    ...
    if (!topRegionsCtx) return;

    const ctx1 = topRegionsCtx.getContext('2d');
    new Chart(ctx1, {
      type: 'pie',
      data: {
    ...
    if (!provinceCtx) return;

    const ctx2 = provinceCtx.getContext('2d');
    const provinceStats = {};
  ...
  if (typeof Chart !== 'undefined') {
    ...
    window.addEventListener('chartjs-loaded', initRegionCharts);
