          ...
          <table class="table table-hover mb-0">
            ...
            >
              <tr
                      ...
                      data-region="${region.siNm}"
                      data-sgg="${region.sggNm}"
              >
                <td>
                        <span
                ...
                <td><i class="bi bi-geo"></i> ${region.sggNm}</td>
                <td>
                        <span class="fw-bold">
                          <fmt:formatNumber
                ...
                <td>
                  <a
                          href="/corp/list?siNm=${region.siNm}&sggNm=${region.sggNm}"
...
<script>
  ...
  if (!provinceStats['${region.siNm}']) {
    provinceStats['${region.siNm}'] = 0;
  }
  provinceStats['${region.siNm}'] += ${region.totalCount};
  </c:forEach>
